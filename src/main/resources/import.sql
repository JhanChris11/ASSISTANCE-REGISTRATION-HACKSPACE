...
insert into usuarios(password,username,tipousuario_id) values('$2a$10$vql4oLGJAk6TH1Sq.LvIeOcbEBAoHYtJOVlBpZKpDDvEUvUrx2fq2','Sergio',1)
insert into personas(apellido_materno,apellido_paterno,cuenta_github,dni,lugar_residencia,telefono,usuarios_id) values('Diaz','Ramos','Barca','665889910','Lima','944831970',3)
